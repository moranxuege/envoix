...
/// (`registry/release-ledger.toml`), so the only pre-v9 records anywhere are on
...
pub const PRODUCT_RECORD_VERSION: u32 = 9;
...
pub const OLDEST_READABLE_RECORD_VERSION: u32 = 9;
