...
/// (`registry/release-ledger.toml`), so the only pre-v8 records anywhere are on
...
pub const PRODUCT_RECORD_VERSION: u32 = 8;
...
pub const OLDEST_READABLE_RECORD_VERSION: u32 = 8;
