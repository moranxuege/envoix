...
pub(crate) fn can_pause_durable_activity(activity: &FfiTransferActivityRecord) -> bool {
    matches!(
        activity.state,
...
pub(crate) fn can_resume_durable_activity(activity: &FfiTransferActivityRecord) -> bool {
    matches!(
        activity.state,
...
pub(crate) fn can_cancel_durable_activity(activity: &FfiTransferActivityRecord) -> bool {
    matches!(
        activity.state,
        FfiTransferActivityState::Queued
            | FfiTransferActivityState::Binding
...
pub(crate) fn durable_runtime() -> Result<&'static Runtime, EnvoixError> {
    DURABLE_RUNTIME
