...
3. Complete a manual or foreground UI test of the Windows native file picker
   and final Send button. Background UI Automation verified the shell's
   accessible controls and post-transfer projections, but the modal picker
   correctly rejected synthetic background file selection.
